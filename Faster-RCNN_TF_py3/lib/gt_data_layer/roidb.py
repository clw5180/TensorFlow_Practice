...
def prepare_roidb(imdb):
    ...
    if os.path.exists(cache_file):
        ...
        print('{} gt roidb prepared loaded from {}'.format(imdb.name, cache_file)) # clw modify: for py3
        return
    ...
    print('wrote gt roidb prepared to {}'.format(cache_file)) # clw modify: for py3
