...
class coco(imdb):
    ...
    def _roidb_from_proposals(self, method):
        ...
        print('wrote {:s} roidb to {:s}'.format(method, cache_file)) # clw modify:for py3
        return roidb
    ...
    def _load_proposals(self, method, gt_roidb):
        ...
        print('Loading {} boxes'.format(method)) # clw modify:for py3
        for i, index in enumerate(self._image_index):
            if i % 1000 == 0:
                print('{:d} / {:d}'.format(i + 1, len(self._image_index))) # clw modify:for py3
    ...
    def _print_detection_eval_metrics(self, coco_eval):
        ...
        print('{:.1f}'.format(100 * ap_default))  # clw modify: for py3
