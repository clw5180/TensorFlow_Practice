...
ANCHOR_SCALES = [0.1, 0.14, 0.17, 0.2, 0.23, 0.26, 0.29, 0.33, 0.4, 0.5]
# clw modify：钢筋检测中，框的尺寸在30-300之间，多数集中在70到200之间
# 用kmeans得到一批在70到200之间的数，如果BASE_ANCHOR_SIZE=256，二者相除得到scale：[0.29, 0.34, 0.39, 0.45, 0.52, 0.57, 0.66, 0.8]
# 另外原图是2000*2666，我要缩放到1000*1333，因此上面这个值还要除以2：[0.14, 0.17, 0.2, 0.23, 0.26, 0.29, 0.33, 0.4]
